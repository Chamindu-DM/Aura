  ...
  return (
    ...
    <div data-layer="Form Container" className="FormContainer w-full max-w-[800px] px-10 py-4 inline-flex justify-center items-start gap-10">
        <div data-layer="Profile Picture Container" className="ProfilePictureContainer inline-flex flex-col justify-start items-center gap-2">
            <div data-layer="Profile Picture" data-show-profile-photo="off" className="ProfilePicture w-24 h-24 bg-black/20 rounded-2xl outline-1 outline-black/10 flex flex-col justify-center items-center gap-2 overflow-hidden">
            ...
            <div data-layer="Change Picture Button" className="ChangePictureButton text-center justify-start text-black text-xs font-normal font-['Inter'] underline cursor-pointer">Change</div>
        </div>
